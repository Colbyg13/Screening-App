                    ...
                    {allFieldKeys
                        ...
                        .map(key => (
                            <RecordModalInputRow
                                ...
                                record={record}
                                onChange={newValue =>
                                    setUpdate(update => ({ ...update, [key]: newValue }))
                                }
                            />
                        ))}
                </div>
                    ...
                    <div className="flex space-x-2">
                        ...
                        {sessionIsRunning ? (
                            <div className="text-red-600">
                                Please stop the session to delete record
                            </div>
                        ) : null}
                    </div>
                    <div className="flex space-x-2">
                        ...
                        <Button
                            ...
                            color="success"
                            variant="contained"
                            disabled={allFieldKeys.every(
                                key => update[key] === undefined || record?.[key] === update[key],
                            )}
                            onClick={async () => {
                                const customDataToUpdate = customDataTypes.reduce(
