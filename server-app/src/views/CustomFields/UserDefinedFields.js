    ...
    return (
        <div className="py-4 px-8 bg-white rounded-md shadow-md">
            ...
            <div className="flex flex-col space-y-2">
                ...
                {customDataTypes.map(
                    ({ _id, type, unit, values, fakeId }, dataTypeIndex) =>
                        console.log({
                            [`measurement-${_id ?? fakeId}`]: measurementMap[_id ?? fakeId],
                        }) || (
                                    ...
                                    measurementMap[_id ?? fakeId] === CUSTOM_DATA_TYPE ? (
                                        <div className="space-y-2">
                                            ...
                                            <Button
                                                ...
                                                variant="outlined"
                                                onClick={() =>
                                                    addCustomDataTypeValue(dataTypeIndex)
                                                }
                                            >
                                                Add Value
                                            </Button>
